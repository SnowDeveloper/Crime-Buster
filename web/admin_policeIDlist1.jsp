                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li><a href="admin_policeIDlist.jsp">View Police IDs</a>
                            </li>
                            <li class="active"><a href="admin_policeIDlist1.jsp">Add Police ID</a>
                            </li>
            ...
            <div>
                ...
                <section id="main" class="column">
                    ...
                    <article class="module width_full">
                        <header><h3>Add Police ID</h3></header>


                        <form name="PIDEForm" id="PoliceIDEntryForm" method="post" action="admin_policeIDlist1a.jsp"
                            ...
                            <fieldset>
                                ...
                                <div align="center">
                                    ...
                                    <input id="refn" name="refn" value="" type="text" placeholder="For example: 16"
                                           size="50"/>
                                ...
                                <div align="center">
                                    <label for="pid">Enter Police ID :</label>
                                    <input id="pid" name="pid" value="" type="text" placeholder="For example: 12564"
                                           size="50"/>
...
<script type="text/javascript">
    function validateF() {
        var refn = document.PIDEForm.refn.value;
        var pid = document.PIDEForm.pid.value;
        ...
        if (pid == null || pid == "" || isNaN(pid)) {
            ...
            $("#pid").val('');
            $("#pid").attr("placeholder", "Police ID should be filled and numeric");
            $("#pid").addClass("placeholder");
            $('html, body').animate({
