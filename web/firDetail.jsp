    ...
    <div id="container">
        <div id="content">
            ...
            <section id="main" class="column" style="text-align: center;">
                ...
                <div style="color: #FFFFFF; font-size: 25pt;text-decoration:underline;">FIR Complaints</div>
                <br>

                <%
                    Class.forName("org.sqlite.JDBC").newInstance();
                    Connection con = DriverManager.getConnection("jdbc:sqlite:C:/sqlite/wcomplaint");
                    PreparedStatement psmnt = con.prepareStatement("select * from fircomplaint ");
                ...
                <TABLE BORDER="1" style="color:navajowhite" width="500" height="300">
                    <TR>
                        ...
                        <TH>
                            <h3>
                                <div style="color: #FFFFFF; font-size: 15pt;">Complaint Type</div>
                            </h3>
                        </TH>
                        <TH>
                            <h3>
                        ...
                        <TH>
                            <h3>
                                <div style="color: #FFFFFF; font-size: 15pt;">Detail</div>
                            </h3>
                        </TH>
                        <TH>
                            <h3>
