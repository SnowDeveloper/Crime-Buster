                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li class="active"><a href="admin_policeRanklist.jsp">View Police Rank</a>
                            </li>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover" style="text-align: center;">
                    ...
                    <section id="main" class="column" style="text-align: center;">
                        ...
                        <div style="color: darkblue; font-size: 25pt;text-decoration:underline;">Police Ranks</div>
                        <br>

                            <%
              Class.forName("org.sqlite.JDBC").newInstance();
              Connection con = DriverManager.getConnection("jdbc:sqlite:C:/sqlite/wcomplaint");
              PreparedStatement psmnt = con.prepareStatement("select * from prank ");
