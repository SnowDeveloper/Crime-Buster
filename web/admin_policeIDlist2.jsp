                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active"><a href="admin_policeIDlist2.jsp">Remove Police ID</a>
                            </li>
                        </ul>
                    </div>
                    <!--/.nav-collapse -->
            ...
            <div>
                ...
                <section id="main" class="column">
                    ...
                    <article class="module width_full">
                        <header><h3>Remove Police ID</h3></header>

                        <form name="PIDRForm" id="PoliceIDRemovalForm" method="post" action="admin_policeIDlist2a.jsp"
...
<script type="text/javascript">
    function validateF() {
        var refn = document.PIDRForm.refn.value;
