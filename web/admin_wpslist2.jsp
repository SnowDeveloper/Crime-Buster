...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="admin_wpslist1.jsp">Add Women P.S.</a>
                            </li>
                            <li class="active"><a href="admin_wpslist2.jsp">Remove Women P.S.</a>
                            </li>
                        </ul>
                    </div>
                    <!--/.nav-collapse -->
            ...
            <div>
                <div name="AdminWPSRStage"></div>
                <section id="main" class="column">
                    <%
                        String s = (String) request.getAttribute("register");
                        if (s != null && s.equals("success")) {
                    %>
                    <h4 class="alert_info" style="color:green">Successfully Removed It!</h4>
                    <% }
                    %>
                    <%
                    ...
                    %>
                    <h4 class="alert_info" style="color:red">ID given Invalid and Does Not Exit!</h4>
                    <% }
                    %>


                    <article class="module width_full">
                        <header><h3>Remove Women Police Station</h3></header>

                        <form name="WPSRForm" id="WomenPoliceStationRemovalForm" method="post"
                              action="admin_wpslist2a.jsp" onsubmit="return(validateF());">

                            <fieldset>
                                <br><br><br><br><br>

                                <div align="center">
                                    <label for="id">Enter Reference Number :</label>
...
<script type="text/javascript">
    function validateF() {
        var id = document.WPSRForm.id.value;
