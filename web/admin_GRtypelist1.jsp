            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        General Report Page
                        <small>General Complaint Types</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <i class="fa fa-wrench"></i> General Complaint Type
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="navbar navbar-inverse">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="admin_GRtypelist.jsp">General Complaint Type</a>
                    </div>
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li><a href="admin_GRtypelist.jsp">View Complaint Types</a>
                            </li>
                            <li class="active"><a href="admin_GRtypelist1.jsp">Add Complaint Type</a>
                            </li>
                            <li><a href="admin_GRtypelist2.jsp">Remove Complaint Type</a>
                            </li>
                        </ul>
                    </div>
                    <!--/.nav-collapse -->
            ...
            <div>
                ...
                <section id="main" class="column">
                    ...
                    <article class="module width_full">
                        <header><h3>Add Complaint Type</h3></header>


                        <form name="GCTEForm" id="GeneralComplaintTypeEntryForm" method="post"
                              action="admin_GRtypelist1a.jsp" onsubmit="return(validateF());">
                            ...
                            <fieldset>
                                ...
                                <div align="center">
                                    ...
                                    <input id="refn" name="refn" value="" type="text" placeholder="For example: 169"
                                           size="50"/>
                                ...
                                <div align="center">
                                    <label for="types">Enter Complaint Type :</label>
                                    <input id="types" name="types" value="" type="text" placeholder="For example: Theft"
                                           size="50"/>
...
<script type="text/javascript">
    function validateF() {
        var refn = document.GCTEForm.refn.value;
        var types = document.GCTEForm.types.value;
        ...
        if (types == null || types == "") {
            ...
            $("#refn").val('');
            $("#types").attr("placeholder", "Complaint Type should be filled and numeric");
