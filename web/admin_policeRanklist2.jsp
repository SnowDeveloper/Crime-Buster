                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="admin_policeRanklist1.jsp">Add Police Rank</a>
                            </li>
                            <li class="active"><a href="admin_policeRanklist2.jsp">Remove Police Rank</a>
                            </li>
                        </ul>
                    </div>
                    <!--/.nav-collapse -->
            ...
            <div class="table-responsive">
                ...
                <section id="main" class="column">
                    ...
                    <article class="module width_full">
                        <header><h3>Remove Police Rank</h3></header>

                        <form name="PRRForm" id="PoliceRankRemovalForm" method="post"
                              action="admin_policeRanklist2a.jsp" onsubmit="return(validateF());">
...
<script type="text/javascript">
    function validateF() {
        var refn = document.PRRForm.refn.value;
