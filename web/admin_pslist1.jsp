            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        Contact Police Page
                        <small>Police Station List</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <i class="fa fa-wrench"></i> Police Station List
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="navbar navbar-inverse">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="admin_pslist.jsp">Police Station</a>
                    </div>
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li><a href="admin_pslist.jsp">View Police Station</a>
                            </li>
                            <li class="active"><a href="admin_pslist1.jsp">Add Police Station</a>
                            </li>
                            <li><a href="admin_pslist2.jsp">Remove Police Station</a>
                            </li>
                        </ul>
                    </div>
                    <!--/.nav-collapse -->
            ...
            <div>
                ...
                <section id="main" class="column">
                    ...
                    <article class="module width_full">
                        <header><h3>Add Police Station</h3></header>


                        <form name="PSEForm" id="PSEntryForm" method="post" action="admin_pslist1a.jsp"
                            ...
                            <fieldset>
                                ...
                                <div align="center">
                                    ...
                                    <input id="name" name="name" value="" type="text"
                                           placeholder="For example: Kona Police Station" size="50"/>
                                ...
                                <div align="center">
                                    ...
                                    <input id="address" name="address" value="" type="text"
                                           placeholder="The authorized address" size="50"/>
...
<script type="text/javascript">
    function validateF() {
        var id = document.PSEForm.id.value;
        var name = document.PSEForm.name.value;
        var address = document.PSEForm.address.value;
        var contact = document.PSEForm.contact.value;
        ...
        if (address == null || address == "") {
            ...
            $("#address").val('');
            $("#address").attr("placeholder", "Address should be filled and not numeric");
            $("#address").addClass("placeholder");
            $('html, body').animate({
