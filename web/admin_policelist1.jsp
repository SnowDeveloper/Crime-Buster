            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-wrench"></i> Police List
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="navbar navbar-inverse">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="admin_policelist.jsp">Police Team</a>
                    </div>
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li><a href="admin_policelist.jsp">View Police Team</a>
                            </li>
                            <li class="active"><a href="admin_policelist1.jsp">Remove Police</a>
                            </li>
                        </ul>
                    </div>
                    <!--/.nav-collapse -->
            ...
            <div>
                ...
                <section id="main" class="column">
                    ...
                    <article class="module width_full">
                        <header><h3>Remove Police</h3></header>

                        <form name="PRForm" id="PoliceRemovalForm" method="post" action="admin_policelist1a.jsp"
...
<script type="text/javascript">
    function validateF() {
        var refn = document.PRForm.refn.value;
