    ...
    <div id="container">
        <div id="content">
            ...
            <section id="main" class="column" style="text-align: center;">
                ...
                <div style="color: #FFFFFF; font-size: 25pt;text-decoration:underline;">No Crime Certificate Details
                </div>
                <br>
                ...
                <%
                    ...
                    PreparedStatement psmnt = con.prepareStatement("select * from nocrimecerti ");
