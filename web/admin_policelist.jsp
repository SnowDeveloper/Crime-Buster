                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li class="active"><a href="admin_policelist.jsp">View Police Team</a>
                            </li>
                            <li><a href="admin_policelist1.jsp">Remove Police</a>
                            </li>
                        </ul>
                    </div>
                    <!--/.nav-collapse -->
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover" style="text-align: center;">
                    ...
                    <section id="main" class="column" style="text-align: center;">
                        ...
                        <div style="color: darkblue; font-size: 25pt;text-decoration:underline;">Police List</div>
                        <br>

                            <%
              Class.forName("org.sqlite.JDBC").newInstance();
              Connection con = DriverManager.getConnection("jdbc:sqlite:C:/sqlite/wcomplaint");
              PreparedStatement psmnt = con.prepareStatement("select * from polices ");
            ...
            %>
                        ...
                        <thread>
                            <TR>
                                ...
                                <TH>
                                    <h3>
                                        <div style="color: black; text-decoration: underline; text-align: center;">Age
                                        </div>
                                    </h3>
                                </TH>
                                <TH>
