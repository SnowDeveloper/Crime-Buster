        ...
        <div id="content">
            ...
            <section id="main" class="column">
                ...
                <article class="module width_full">
                    <header><h3>Remove Issued No Crime Certificate</h3></header>

                    <form name="NCCRForm" id="NoCrimeCertificateRemovalForm" method="post" action="ncc2.jsp"
...
<script type="text/javascript">
    function validateF() {
        var refn = document.NCCRForm.refn.value;
