...
<jsp:useBean id="admin_policeRanklist" class="pkg.admin_policeRanklist_init">
    ...
    <jsp:setProperty name="admin_policeRanklist" property="*"/>

</jsp:useBean>
<%
    int i = admin_policeRanklist.register();
    if (i > 0) {
        //out.print("<br>Inserted");
        request.setAttribute("register", "success");

        RequestDispatcher rd = request.getRequestDispatcher("admin_policeRanklist1.jsp");
