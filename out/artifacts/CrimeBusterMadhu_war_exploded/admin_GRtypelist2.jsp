        ...
        <div class="container-fluid">
                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="admin_GRtypelist1.jsp">Add Complaint Type</a>
                            </li>
                            <li class="active"><a href="admin_GRtypelist2.jsp">Remove Complaint Type</a>
                            </li>
                        </ul>
                    </div>
                    <!--/.nav-collapse -->
            ...
            <div>
                ...
                <section id="main" class="column">
                    ...
                    %>
                    <h4 class="alert_info" style="color:red">Reference Number Invalid and Does Not Exit!</h4>
                    <% }
                    %>


                    <article class="module width_full">
                        <header><h3>Remove Complaint Type</h3></header>

                        <form name="GCTRForm" id="GeneralComplaintTypeRemovalForm" method="post"
                              action="admin_GRtypelist2a.jsp" onsubmit="return(validateF());">
...
<script type="text/javascript">
    function validateF() {
        var refn = document.GCTRForm.refn.value;
