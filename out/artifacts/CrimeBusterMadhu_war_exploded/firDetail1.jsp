        ...
        <div id="content">
            ...
            <section id="main" class="column">
                ...
                <article class="module width_full">
                    <header><h3>Remove Resolved FIR Complaint</h3></header>

                    <form name="FIRRForm" id="FIRRemovalForm" method="post" action="firDetail2.jsp"
...
<script type="text/javascript">
    function validateF() {
        var refn = document.FIRRForm.refn.value;
