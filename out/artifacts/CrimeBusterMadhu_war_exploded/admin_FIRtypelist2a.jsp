...
<jsp:useBean id="admin_FIRtypelist" class="pkg.admin_FIRtypelist_init">
    ...
    <jsp:setProperty name="admin_FIRtypelist" property="refn"/>

</jsp:useBean>
<%
    int i = admin_FIRtypelist.remove();
    if (i > 0) {
        //out.print("<br>Inserted");
        request.setAttribute("register", "success");

        RequestDispatcher rd = request.getRequestDispatcher("admin_FIRtypelist2.jsp");
