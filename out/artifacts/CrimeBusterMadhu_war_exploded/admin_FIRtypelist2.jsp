                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="admin_FIRtypelist1.jsp">Add Complaint Types</a>
                            </li>
                            <li class="active"><a href="admin_FIRtypelist2.jsp">Remove Complaint Types</a>
                            </li>
                        </ul>
                    </div>
                    <!--/.nav-collapse -->
            ...
            <div>
                ...
                <section id="main" class="column">
                    ...
                    <article class="module width_full">
                        <header><h3>Remove FIR Type</h3></header>

                        <form name="FIRTRForm" id="FIRTypeRemovalForm" method="post" action="admin_FIRtypelist2a.jsp"
...
<script type="text/javascript">
    function validateF() {
        var refn = document.FIRTRForm.refn.value;
