            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        Contact Police Page
                        <small>Women Police Station List</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <i class="fa fa-wrench"></i> Women Police Station List
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="navbar navbar-inverse">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="admin_wpslist.jsp">Women P.S.</a>
                    </div>
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li><a href="admin_wpslist.jsp">View Women P.S.</a>
                            </li>
                            <li class="active"><a href="admin_wpslist1.jsp">Add Women P.S.</a>
                            </li>
                            <li><a href="admin_wpslist2.jsp">Remove Women P.S.</a>
                            </li>
                        </ul>
                    </div>
                    <!--/.nav-collapse -->
            ...
            <div>
                ...
                <section id="main" class="column">
                    ...
                    <article class="module width_full">
                        <header><h3>Add Women Police Station</h3></header>


                        <form name="WPSEForm" id="WPSEntryForm" method="post" action="admin_wpslist1a.jsp"
                            ...
                            <fieldset>
                                ...
                                <div align="center">
                                    ...
                                    <input id="id" name="id" value="" type="text" placeholder="For example: 200"
                                           size="50"/>
                                ...
                                <div align="center">
                                    <label for="name">Enter Name of P.S. :</label>
                                    <input id="name" name="name" value="" type="text"
                                           placeholder="For example: Suri Women Police Station" size="50"/>
                                ...
                                <div align="center">
                                    <label for="jurisdiction">Enter Jurisdiction :</label>
                                    <input id="jurisdiction" name="jurisdiction" value="" type="text"
                                           placeholder="The authorized address/jurisdiction" size="50"/>
                                ...
                                <div align="center">
                                    ...
                                    <input id="contact" name="contact" value="" type="text"
                                           placeholder="For example: 033-26659898" size="50"/>
...
<script type="text/javascript">
    function validateF() {
        var id = document.WPSEForm.id.value;
        var name = document.WPSEForm.name.value;
        var jurisdiction = document.WPSEForm.jurisdiction.value;
        var contact = document.WPSEForm.contact.value;

        if (id == null || id == "" || isNaN(id)) {

            $("#id").val('');
            $("#id").attr("placeholder", "ID should be filled and numeric");
        ...
        if (name == null || name == "") {
            ...
            $("#name").val('');
            $("#name").attr("placeholder", "Name of P.S. should be filled and not numeric");
        ...
        if (jurisdiction == null || jurisdiction == "") {
            ...
            $("#jurisdiction").val('');
            $("#jurisdiction").attr("placeholder", "Jurisdiction should be filled and not numeric");
            $("#jurisdiction").addClass("placeholder");
            $('html, body').animate({
                scrollTop: $("#jurisdiction").offset().top
            }, 'slow');
            return false;
        }
        if (contact == null || contact == "") {
            ...
            $("#contact").val('');
            $("#contact").attr("placeholder", "Contact Number should be filled");
            $("#contact").addClass("placeholder");
            $('html, body').animate({
