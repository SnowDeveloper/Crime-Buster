...
<jsp:useBean id="admin_policeIDlist" class="pkg.admin_policeIDlist_init">
    ...
    <jsp:setProperty name="admin_policeIDlist" property="refn"/>

</jsp:useBean>
<%
    int i = admin_policeIDlist.remove();
    if (i > 0) {
        //out.print("<br>Inserted");
        request.setAttribute("register", "success");

        RequestDispatcher rd = request.getRequestDispatcher("admin_policeIDlist2.jsp");
