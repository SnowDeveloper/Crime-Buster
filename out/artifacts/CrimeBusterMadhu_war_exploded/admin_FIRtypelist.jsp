                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li class="active"><a href="admin_FIRtypelist.jsp">View Complaint Types</a>
                            </li>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover" style="text-align: center;">
                    ...
                    <section id="main" class="column" style="text-align: center;">
                        ...
                        <div style="color: darkblue; font-size: 25pt;text-decoration:underline;">FIR Complaint Type
                        </div>
                        <br>
              ...
              PreparedStatement psmnt = con.prepareStatement("select * from firtype ");
