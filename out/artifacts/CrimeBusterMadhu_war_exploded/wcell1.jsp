        ...
        <div id="content">
            ...
            <section id="main" class="column">
                ...
                <article class="module width_full">
                    <header><h3>Remove Resolved Women Complaint</h3></header>

                    <form name="WCRForm" id="WomenComplaintRemovalForm" method="post" action="wcell2.jsp"
...
<script type="text/javascript">
    function validateF() {
        var refn = document.WCRForm.refn.value;
