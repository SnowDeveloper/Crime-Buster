            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-wrench"></i> Police Rank List
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="navbar navbar-inverse">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="admin_policeRanklist.jsp">Police Team</a>
                    </div>
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li><a href="admin_policeRanklist.jsp">View Police Rank</a>
                            </li>
                            <li class="active"><a href="admin_policeRanklist1.jsp">Add Police Rank</a>
                            </li>
                            <li><a href="admin_policeRanklist2.jsp">Remove Police Rank</a>
                            </li>
                        </ul>
                    </div>
                    <!--/.nav-collapse -->
            ...
            <div>
                ...
                <section id="main" class="column">
                    ...
                    <article class="module width_full">
                        <header><h3>Add Police Rank</h3></header>


                        <form name="PREForm" id="PoliceRankEntryForm" method="post" action="admin_policeRanklist1a.jsp"
                            ...
                            <fieldset>
                                ...
                                <div align="center">
                                    <label for="types">Enter Police Rank :</label>
                                    <input id="types" name="types" value="" type="text"
                                           placeholder="For example: Super CID" size="50"/>
...
<script type="text/javascript">
    function validateF() {
        var refn = document.PREForm.refn.value;
        var types = document.PREForm.types.value;
        ...
        if (types == null || types == "") {
            ...
            $("#types").val('');
            $("#types").attr("placeholder", "Police Rank should be filled");
