...
<div class="wrapper col3">
    <div id="breadcrumb">
        <ul>
            ...
            <li>&#187;</li>
            <li class="current"><a href="GeneralReport.jsp">General Report</a></li>
        </ul>
    </div>
</div>
...
<div class="wrapper col4">
    <div id="container">
        <div id="content">
            <div name="GeneralComplaint"><h1 style="color:white">Submit Complaint (General Diary)</h1></div>
            <form name="gcForm" action="genservlet" method="post" onsubmit="return(validateF());">
                <p align="center-left">
                    ...
                    <label>
                        <select id="TheOption" name="option">
                            ...
                            <%
                                ...
                                PreparedStatement psmnt = con.prepareStatement("select types from complainttype ");
    ...
    <div id="column">
        <div class="subnav">
            <h2 style="color:white">Check Reference Number Details (General Complaints Only)</h2>

            <form name="gfrm" action="GeneralReferenceServlet" method="post" onsubmit="return(validateForm());">
                <div class="row">
...
<script type="text/javascript">
    function validateF() {
        var name = document.gcForm.name.value;
        var email = document.gcForm.email.value;
        var age = document.gcForm.age.value;
        var option = document.gcForm.option.value;
        var phonenum = document.gcForm.num.value;
        var addr = document.gcForm.add.value;
        var detail = document.gcForm.detail.value;
        ...
        $.ajax({
            ...
            success: function (data) {
                $('form[name="gcForm"]').trigger("reset");
                $('form[name="gcForm"]').closest("form").hide();
                $('div[name="GeneralComplaint"]').closest("div").text(data);
                $('div[name="GeneralComplaint"]').closest("div").append("<br><br><a onclick='return(ReForm());'>Click Here for New Complaint</a>");
            }
        });
        return false;
    }
...
<script type="text/javascript">
    function ReForm() {
        $('form[name="gcForm"]').closest("form").trigger("reset");
        $('form[name="gcForm"]').closest("form").show();
        $('div[name="GeneralComplaint"]').closest("div").text("Enter Details");
    }
</script>
...
<script type="text/javascript">
    function validateForm() {
        ...
        var ref = document.gfrm.ref.value;
        ...
        $.ajax({
            type: "POST",
            url: "/GeneralReferenceServlet",
            data: {_ref: ref},
            success: function (data) {
                var dataSplit = data.split(";");
                $('form[name="gcForm"]').closest("form").hide();
                $('div[name="GeneralComplaint"]').closest("div").html("<h1>Your Complaint Details:</h1><br><br>");
                if (dataSplit.length > 1) {
                    $('div[name="GeneralComplaint"]').append("Your Name: " + dataSplit[0] + " and your Email id is: " + dataSplit[1]);
                    $('div[name="GeneralComplaint"]').append("<br><br> Your details are successfully recorded into our System - CrimeBuster.");
                    $('div[name="GeneralComplaint"]').append("<br><br> The complaint is Under Processing!<br><br> In case of 'Missing Person' file FIR within 24 hours!");
                    $('div[name="GeneralComplaint"]').append("<br><br>Kindly Come to the nearest Police Station with your Reference Number and other proofs. <br>For Nearest Police Station click on <a href='ContactPolice.jsp'> 'Contact Police'</a> section.");
                }
                else {
                    $('div[name="GeneralComplaint"]').append("Invalid Reference No.!<br><br>Try Again!");
                }
                $('div[name="GeneralComplaint"]').closest("div").append("<br><br><br><br><a onclick='return(ReForm());'>Click Here For New Complaint</a>");
            }
        });
        return false;
