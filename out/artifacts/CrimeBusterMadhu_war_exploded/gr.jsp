    ...
    <div id="container">
        <div id="content">
            ...
            <section id="main" class="column" style="text-align: center;">
                ...
                <div style="color: #FFFFFF; font-size: 25pt;text-decoration:underline;">General Complaints</div>
                <br>

                <%
                    Class.forName("org.sqlite.JDBC").newInstance();
                    Connection con = DriverManager.getConnection("jdbc:sqlite:C:/sqlite/wcomplaint");
                    PreparedStatement psmnt = con.prepareStatement("select * from gencomplaint ");
