                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li class="active"><a href="admin_GRtypelist.jsp">View Complaint Types</a>
                            </li>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover" style="text-align: center;">
                    ...
                    <section id="main" class="column" style="text-align: center;">
                        ...
                        <div style="color: darkblue; font-size: 25pt;text-decoration:underline;">General Complaint
                            Type
                        </div>
                        <br>
              ...
              PreparedStatement psmnt = con.prepareStatement("select * from complainttype ");
