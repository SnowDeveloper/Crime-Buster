...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="jumbotron">
                <h1>Crime Buster says, 'Hello, Admin!'</h1>

                <p>Crime Buster is an Online Platform to make complaints easier for the Common Citizen as well as for
                    the Police Authorities who can easily update executed tasks in the website, <a href="index.jsp">Crime
                        Buster</a>.</p>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"></div>
                                    <div>Police Ranks!</div>
                                </div>
                            </div>
                        </div>
                        <a href="admin_policeRanklist.jsp">
                            <div class="panel-footer">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-primary">
                        ...
                        <a href="admin_policelist.jsp">
                            <div class="panel-footer">
                                <span class="pull-left">Show Polices</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
