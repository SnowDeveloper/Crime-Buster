                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="admin_pslist1.jsp">Add Police Station</a>
                            </li>
                            <li class="active"><a href="admin_pslist2.jsp">Remove Police Station</a>
                            </li>
                        </ul>
                    </div>
                    <!--/.nav-collapse -->
            ...
            <div>
                ...
                <section id="main" class="column">
                    ...
                    <article class="module width_full">
                        <header><h3>Remove Police Station</h3></header>

                        <form name="PSRForm" id="PoliceStationRemovalForm" method="post" action="admin_pslist2a.jsp"
...
<script type="text/javascript">
    function validateF() {
        var id = document.PSRForm.id.value;
