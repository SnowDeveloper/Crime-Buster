...
@WebServlet("/FIRReferenceServlet")
public class FIRReferenceServlet extends HttpServlet{

    private String name,email;

    public FIRReferenceServlet() { super(); }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException {
        ...
        try{
            ...
            String sql = "select name,email from fircomplaint where refn=?";
