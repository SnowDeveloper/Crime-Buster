...
@WebServlet("/GeneralReferenceServlet")
public class GeneralReferenceServlet extends HttpServlet {

    private String name, email;

    public GeneralReferenceServlet() {
        super();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String sql = "select name,email from gencomplaint where refn=?";
